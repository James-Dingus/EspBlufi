...
public interface IBlufiCommunicator {
    ...
    byte NEG_SET_SEC_TOTLE_LEN = 0x00;
    byte NEG_SET_SEC_ALL_DATA = 0x01;
    byte NEG_SET_MESH_ROOT = 0x05;
    byte NEG_SET_MESH_ID = 0x06;
    byte NEG_SET_WIFI_CHANNEL = 0x07;
    byte NEG_SET_CONFIGURE_SEQUENCE = 0x08;
    byte NEG_CHECK_NEG_SEC = 0x09;
